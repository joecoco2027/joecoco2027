...
- 💞️ I’m looking to collaborate on django(backend), react(frontend), react-native/flutter(hybrid-mobile),kotlin/swift(perfomance-extensive-mobile) opencv projects and IOT projects(raspbery pi+FPGAs)
